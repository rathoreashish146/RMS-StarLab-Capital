...
#     bill_path = Column(String, nullable=True)
#     allocation_type = Column(Enum(AllocationType), default=AllocationType.UNALLOCATED)
#     allocation_employee_id = Column(Integer, ForeignKey("employees.id"), nullable=True)  # If allocation_type = EMPLOYEE, points to employees.employee_id
#     allocation_office_id = Column(Integer, ForeignKey("offices.id"), nullable=True)  # If allocation_type = OFFICE, points to offices.office_id
#     returned = Column(Boolean, default=False)
